;(function (window) {
  ...
  let texts = ['星空下', '男孩独自坐望', '星海闪耀', '仿佛在问', '你在想谁', '我在想一个女孩', '这个女孩', '不知道有什么好',  '但男孩觉得', '在他的眼里', '女孩什么都好',  '可爱 善良 聪明 ...',  '男孩一直想着她','想为她做一千件事','想对她说一千句话', '男孩抬起头', '望向星空', '嘿,宝宝', '我想和你一辈子','每天和你在一起', '给你依赖', '给你幸福', '陪伴着你', 'forever']
